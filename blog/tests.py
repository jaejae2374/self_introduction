...
class TestView(TestCase) :
    ...
    def setUp(self) :
        self.client = Client()
        self.user_jaehyun = User.objects.create_user(username='jaehyun', password="abcdefgh")
        self.user_dahyun = User.objects.create_user(username="dahyun", password="abcdefgh")
        self.user_jaehyun.is_staff = True
        self.user_jaehyun.save()
    ...
    def test_create_post(self):
        ...
        self.client.login(username='dahyun', password='abcdefgh')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)


        self.client.login(username="jaehyun", password='abcdefgh')
        response = self.client.get('/blog/create_post/')
        ...
        self.assertEqual(last_post.author.username, 'jaehyun')
    ...
    def test_update_post(self):
        ...
        self.assertNotEqual(self.post_003.author, self.user_dahyun)
        self.client.login(
            username = self.user_dahyun.username,
            password = 'abcdefgh'
        )
        response = self.client.get(update_post_url)
    ...
    def navbar_test(self, soup) :
        ...
        logo_btn = navbar.find('a', text='LeeJaeHyun')
    ...
    def test_post_list(self) :
        ...
        self.assertIn(self.user_jaehyun.username.upper(), main_area.text)
        ...
        def test_post_detail(self):
            ...
            self.assertIn(self.user_jaehyun.username.upper(), post_area.text)
    ...
    def test_comment_form(self):
        ...
        self.assertIn('jaehyun', new_comment_div.text)
        self.assertIn('이재현의 댓글입니다.', new_comment_div.text)

    def test_comment_update(self):
        comment_by_dahyun = Comment.objects.create(
            post=self.post_001,
            author=self.user_dahyun,
            content="이다현의 댓글입니다.",
        )
        ...
        self.assertIn("이재현의 댓글을 수정합니다.", comment_001_div.text)
    ...
    def test_delete_comment(self):
        ...
        self.assertIn(self.post_001.title, soup.title.text)
        comment_area = soup.find('div', id="comment-area")
        self.assertNotIn('이다현의 댓글입니다.', comment_area.text)
